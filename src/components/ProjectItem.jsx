...
export default function ProjectItem({project}){
    function umamiTrackProjectWebsite(){
        umami.trackEvent('Project '+project.title+' link click', project.title);
    }
    ...
    return(
        <div id="PRI-main">
            ...
            <div id="PRI-info">
                ...
                {liens.map((l)=>(
                        <div key={l}>
                            <a href={l} onClick={() => {umamiTrackProjectWebsite()}}><i className="gg-terminal"></i></a>
                        </div>
                ))}
                {liens_pdf.map((l)=>(
                        <div key={l}>
                            <a href={l} onClick={() => {umamiTrackProjectWebsite()}}><i className="gg-file-document"></i></a>
                        </div>
                ))}
                </div>
            </div>
